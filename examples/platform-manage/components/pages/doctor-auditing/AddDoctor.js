        ...
        <Modal.Body>
          <section className="container-fluid" ng-form="addDoctor.form">
            ...
            <div className="row mt-10">
              ...
              <div className="col-xs-6">
                <select enhance-select="addDoctor.hospitalList" ng-model="addDoctor.hospital" required></select>
              </div>
            </div>
            ...
            <div className="row mt-10">
              ...
              <div className="col-xs-6">
                <input required type="text" ng-model="addDoctor.mobile" className="form-control" placeholder="请输入手机号码"/>
              </div>
            </div>
            ...
            <div className="row mt-10">
              <div className="col-xs-6">
                ...
                <div className="row">
                  <div className="center-block w-100">
                    <button className="btn btn-default btn-block" ngf-select ng-model="addDoctor.headImageFile">头像上传
                    </button>
                  </div>
                </div>
              </div>
              <div className="col-xs-6">
                ...
                <div className="row">
                  <div className="center-block w-100">
                    <button className="btn btn-default btn-block" ngf-select ng-model="addDoctor.holdCardImageFile">
                      持牌照片
                    </button>
                  </div>
                </div>
