      ...
      <div className="app-header navbar">
        ...
        <div className="collapse pos-rlt navbar-collapse box-shadow bg-white-only">
          <div className="nav navbar-nav hidden-xs">
            <a href className="btn no-shadow navbar-btn" ng-click="app.settings.asideFolded = !app.settings.asideFolded">
          ...
          <ul className="nav navbar-nav navbar-right">
            <li>
              <a ng-click="app.settings.asideMessage = !app.settings.asideMessage">
                ...
                <span className="badge badge-sm up bg-danger pull-right-xs">{this.props.messageCount}</span>
              </a>
            </li>
            <li uib-dropdown>
